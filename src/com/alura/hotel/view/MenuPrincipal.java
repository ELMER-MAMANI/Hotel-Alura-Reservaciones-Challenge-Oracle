...
public class MenuPrincipal extends JFrame {
    ...
    public MenuPrincipal() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(MenuPrincipal.class.getResource("../image/aH-40px.png")));
        ...
        imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("../image/menu-img.png")));
        panel.add(imagenFondo);

        JLabel logo = new JLabel("");
        logo.setBounds(722, 80, 150, 156);
        logo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("../image/aH-150px.png")));
        panel.add(logo);
        ...
        JLabel lblCopyR = new JLabel("Desarrollado por Elmer Mamani © 2023");
        ...
        JPanel btnLogin = new JPanel();
            ...
            new ImageIcon(MenuPrincipal.class  
    ...
    new Font("Roboto Light", Font.PLAIN, 20));
    }
